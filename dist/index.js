...
function handler(event) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        console.log(event);
        const fromBase64Body = Buffer.from((_a = event.body) !== null && _a !== void 0 ? _a : "", 'base64').toString();
        ...
        const requestPayload = JSON.parse((_b = requestPayloadString.split("payload=").at(-1)) !== null && _b !== void 0 ? _b : "");
        ...
        const artifactDetailsResponse = yield axios_1.default.get(requestPayload.workflow_run.artifacts_url, {
            headers: {
        ...
        const redirectionURL = artifactDetailsResponse.data.artifacts
            .find((artifact) => artifact.name === "site-build-output")
            .archive_download_url;
        console.log("redirection URL: ", redirectionURL);
        const redirectionResponse = yield axios_1.default.get(redirectionURL, {
            headers: {
                "Accept": "application/vnd.github.v3+json",
                "Authorization": `token ${process.env.GH_TOKEN}`
            },
        ...
        try {
            const zipDownloadResponse = yield axios_1.default.get(redirectionResponse.headers["location"], {
                responseType: 'stream'
            });
            console.log("zip download response: ", zipDownloadResponse);
            const zipFileWritable = (0, fs_1.createWriteStream)('/tmp/build.zip');
            yield (0, events_1.once)(zipFileWritable, 'open');
            zipDownloadResponse.data.pipe(zipFileWritable);
            yield (0, events_1.once)(zipFileWritable, 'finish');
            zipFileWritable.close();
            yield (0, events_1.once)(zipFileWritable, 'close');
            console.log((0, fs_1.readdirSync)('/tmp'));
        }
        catch (e) {
            console.error(e);
        }
